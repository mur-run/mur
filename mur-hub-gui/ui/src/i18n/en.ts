export const en = {
  ...
  "perm.addPort": "Add port",
  "perm.portPlaceholder": "2222",
  "perm.ports.base": "Always open: TCP {ports} (any host)",
  "perm.ports.anyHost": "open to any host",
  ...
  "wizard.official.choosePolicy": "Choose model policy",
  "wizard.official.policyTitle": "Choose how MUR selects models",
  "wizard.official.policyHint": "MUR previews a primary model and fallback chain from your local registry. The signed package is checked again during install.",
  "wizard.official.policy.capability-first": "Capability first",
  "wizard.official.policy.capability-first.hint": "Prefer the strongest compatible models.",
  "wizard.official.policy.cost-first": "Cost first",
  "wizard.official.policy.cost-first.hint": "Prefer local, subscription, then lower-cost usage models.",
  "wizard.official.policy.privacy-first": "Privacy first",
  "wizard.official.policy.privacy-first.hint": "Use only compatible models running on this machine.",
  "wizard.official.planning": "Planning model chain…",
  "wizard.official.primary": "Primary",
  "wizard.official.fallbacks": "Fallbacks",
  "wizard.official.confirm": "Confirm and install",
  "wizard.official.warning.UnverifiedToolCapability": "Tool support is not verified",
  "wizard.official.warning.UnknownContextWindow": "Context window is unknown",
  "wizard.official.warning.UnknownPrice": "Price is unknown",
  "wizard.official.warning.StalePrice": "Price data may be stale",
  ...
  "library.usedBy": "Used by",
  "library.notUsed": "No agent uses this yet.",
  "library.selectHint": "Select an item, or add one with +.",
  "library.meta.category": "Category",
  "library.meta.version": "Version",
  "library.meta.status": "Status",
  "library.meta.path": "Path",
  "library.meta.transport": "Transport",
  "library.meta.serverId": "Server id",
  "library.meta.source": "Source",
  "library.meta.skills": "Skills",
  "library.meta.mcp": "MCP",
  "library.meta.commands": "Commands",
  "library.usedByCount": "used by {count}",
  "library.versionPrefix": "v",
  ...
  "settings.fleetAutorun.description": "Fleets with configured triggers will automatically run on schedule without requiring approval. Disabled by default; each fleet must be bounded by a deadline or, on a billable model, a cost cap.",

  "limits.title": "Execution limits",
  "limits.chip.thisFleet": "this fleet",
  "limits.chip.thisAgent": "this agent",
  "limits.chip.fleet": "fleet.yaml",
  "limits.chip.agent": "profile.yaml",
  "limits.chip.config": "config.yaml",
  "limits.chip.builtIn": "built-in default",
  "limits.chip.legacy": "legacy loop.* key",
  "limits.chip.flag": "command-line flag",
  "limits.override": "Override here",
  "limits.reset": "Reset to inherited",
  "limits.save": "Save",
  "limits.cancel": "Cancel",
  "limits.stale": "{key}: {value} in {file} is ignored",
  "limits.remove": "Remove",
  "limits.restartRequired": "restart the agent to apply (Stop, then Start)",
  "limits.error": "limits could not be resolved",
  "limits.badge.bounded": "bounded ✓",
  "limits.badge.deadlineOnly": "bounded by deadline only · no cost cap",
  "limits.badge.unbounded": "unbounded — will not auto-run",
  "limits.card.deadline": "Deadline",
  "limits.card.stuck": "Stuck",
  "limits.card.costCap": "Cost cap",
  "limits.stopped": "stopped: {reason}",
  "limits.finished": "finished",
  "limits.openSettings": "Adjust",
  ...
  "detail.tab.identity": "Identity",
  "detail.tab.capabilities": "Capabilities",
  "detail.tab.memory": "Memory",
  "detail.tab.automation": "Automation",
  "detail.tab.channels": "Channels",
  "fleet.tab.overview": "Overview",
  "fleet.tab.members": "Members",
  "fleet.tab.jobs": "Jobs",
  "fleet.tab.settings": "Settings",
  "fleet.runOptions": "More run options",
  "fleet.run.worktreeOn": "Worktree per track: on",
  "fleet.run.worktreeOff": "Worktree per track: off",
  "fleet.filter": "Filter fleets",
  "fleet.noMatch": "No fleets match.",
  "fleet.cancel": "Cancel",
  ...
  "palette.kind.fleet": "Fleet",
  "palette.action.start": "Start {name}",
  "palette.action.stop": "Stop {name}",
  "palette.action.openInWindow": "Open {name} in window",
  "palette.action.newChat": "New chat",
  "palette.action.newAgent": "New agent",
  "palette.action.settings": "Open Settings",
  "palette.action.refresh": "Refresh",
  "shell.search": "Search or run a command",
  "overview.now": "Now",
  "overview.nothingRunning": "Nothing running right now.",
  "overview.openChat": "Open chat →",
  "overview.review": "Review",
  "overview.costToday": "Cost today",
  "overview.turnsToday": "Turns today",
  "overview.recentTurns": "Turns in recent work",
  "overview.lastActive": "Last active",
  "overview.recent": "Recent work",
  "overview.noRecent": "No recent work.",
  "overview.glance": "Setup at a glance",
  "overview.count": "{count}",
  "detail.section.model": "Model",
  "detail.discardTitle": "Unsaved changes",
  "detail.discardBody": "Discard the changes in this tab?",
  ...
  "action.chat": "Chat",
  "action.openChatWindow": "Open chat in a window",
  "action.openInWindow": "Open in window",
  ...
  "skillslib.filter": "Filter skills",
  "skillslib.noMatch": "No skills match.",
  "skillslib.add": "Add skill",
  "workflowslib.loading": "Loading workflows…",
  "workflowslib.empty": "No workflows saved yet.",
  "workflowslib.openFolder": "Open folder",
  "workflowslib.filter": "Filter workflows",
  "workflowslib.noMatch": "No workflows match.",
  "mcplib.loading": "Loading MCP servers…",
  "mcplib.empty": "No MCP servers installed.",
  "mcplib.filter": "Filter MCP servers",
  "mcplib.noMatch": "No MCP servers match.",
  "mcplib.add": "Add MCP server",
  ...
  "pluginslib.filter": "Filter plugins",
  "pluginslib.noMatch": "No plugins match.",
