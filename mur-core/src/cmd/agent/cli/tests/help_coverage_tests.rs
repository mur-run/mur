...
fn help_name(cmd: &SlashCmd) -> Option<&'static str> {
    match cmd {
        ...
        SlashCmd::Instruct(_) => Some("instruct"),
        SlashCmd::InstructEdit(_) => Some("instruct-edit"),
        SlashCmd::Pin(_) => Some("pin"),
        SlashCmd::Unpin(_) => Some("unpin"),
...
fn one_of_each() -> Vec<SlashCmd> {
    vec![
        ...
        SlashCmd::Instruct(vec![]),
        SlashCmd::InstructEdit(vec![]),
        SlashCmd::Pin(None),
        SlashCmd::Unpin(None),
        SlashCmd::Memories,
