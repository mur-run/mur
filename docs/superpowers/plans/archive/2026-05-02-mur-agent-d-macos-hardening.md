...
- [x] **Step 2: Create the Resources/ directory and the manifest**
...
- [x] **Step 3: Verify the plist parses**
...
- [x] **Step 4: Verify the four reason codes round-trip**
...
- [x] **Step 2: Read the current bundle config**
...
- [x] **Step 3: Edit `bundle.resources`**
...
- [x] **Step 4: Verify the JSON still parses**
...
- [x] **Step 5: Verify the bundle includes the manifest**
...
- [x] **Step 4: Implement `NotarizeCreds` + `notarize_args`**
...
- [x] **Step 2: Append the failing test**
...
- [x] **Step 4: Implement `staple_args`**
...
- [x] **Step 4: Implement `assess_args`**
...
- [x] **Step 2: Create `scripts/check-required-reason-apis.sh`**
...
- [x] **Step 3: Run it locally; expect clean**
...
- [x] **Step 4: Test the negative case**
...
- [x] **Step 1: Read the existing workflow**
...
- [x] **Step 3: Lint the workflow YAML**
...
- [x] **Step 2: Create the cookbook page**
