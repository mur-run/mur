...
- [x] **Step 3: Implement `mur-common/src/identity.rs`**
...
- [x] **Step 2: Run — expect FAIL (to_x25519_static_secret missing)**
...
- [x] **Step 2: Run — expect FAIL (IdentityConfig doesn't exist)**

Run: `cargo test -p mur-common --test profile_schema`
Expected: FAIL.

- [x] **Step 3: Add `IdentityConfig` to agent.rs**
...
- [x] **Step 3: Extend `TransportConfig`**
...
- [x] **Step 4: Commit (if any autofix)**
...
- [x] **Step 3: Implement `mur-agent-runtime/src/transport/noise.rs`**
...
- [x] **Step 3: Implement `mur-agent-runtime/src/transport/tcp.rs`**
...
- [x] **Step 2: Run — should pass without code change**
...
- [x] **Step 4: Update existing card tests if any break**
...
- [x] **Step 1: Locate current `create` implementation**
...
- [x] **Step 4: Extract + modify create logic**
...
- [x] **Step 2: Run — may PASS already** (if existing card command prints the profile JSON)

Run: `cargo test -p mur-core --test agent_card_cli`

- [x] **Step 3: If FAIL, extend print logic**
...
- [x] **Step 1: Failing test (which should already pass thanks to serde defaults)**
...
- [x] **Step 2: Run — must pass (verifies A5 defaults work)**
...
- [x] **Step 1: Document Q-B decision in spec § 13**
...
- [x] **Step 1: Enter commander workspace**
...
- [x] **Step 2: Add mur-common as a path dep**
...
- [x] **Step 5: Confirm legacy tests still pass**
...
- [x] **Step 3: Test that `/.well-known/agent.json` exposes these**
...
- [x] **Step 3: Extend `RegisteredAgent`**
...
- [x] **Step 4: Update existing `register(card)` to also fill `uuid`/`pubkey` from card**
...
- [x] **Step 4: Implement `murmur_bridge.rs`**
...
- [x] **Step 3: Implement `redaction.rs`**
...
- [x] **Step 3: Implement `collector.rs`**
...
- [x] **Step 5: Wire collector into daemon startup (same pattern as E3)**
...
- [x] **Step 2: Parse into `RedactionMode`**
...
- [x] **Step 2: Make executable + commit**
...
- [x] **Step 1: Push mur workspace branch**
...
- [x] scripts/e2e/p0a5-full.sh passes after commander branch is also merged
- [x] Legacy P0a agents without identity still load
...
- [x] **Step 2: Push commander branch**
