...
- [x] **Step 1: Failing test (extend round-trip test)**
...
- [x] **Step 3: Implement** at `mur-core/src/character_card/extensions.rs`:
...
- [x] **Step 3: Implement** at `mur-core/src/character_card/canonical.rs`:
...
- [x] **Step 2: Implement** at `mur-core/src/character_card/signing.rs`:
...
- [x] **Step 3: Implement** at `mur-core/src/cmd/agent_companion/card/png.rs`:
...
- [x] **Step 1: Failing assertion (extend `extract_v3_chunk` test)**
...
- [x] **Step 2: Implement (append to png.rs)**
...
- [x] **Step 2: Implement** at `mur-core/src/cmd/agent_companion/card/cai.rs`:
...
- [x] **Step 2: Wire into the parent dispatcher**
...
- [x] **Step 4: Test export round-trip**
