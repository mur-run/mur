...
- [x] **Step 5: Run full mur-common suite**
...
- [x] **Step 3: Implement `ProvenanceLedger`**
...
- [x] **Step 2: Run, fail with `unresolved import`.**
...
- [x] **Step 2: Add deps + bin target to `mur-agent-gui/src-tauri/Cargo.toml`**
...
- [x] **Step 1: Failing test (extends M3.2.2's E2E)**
...
- [x] **Step 2: Implement `DecoderClient`**
...
- [x] **Step 3: Generate the fixture PDF**
...
- [x] **Step 2: Implement the PDF branch in `MultimodalPipeline::process`**
...
- [x] **Step 1: Add target-gated deps**
...
- [x] **Step 2: Failing test (Linux/Windows only)**
...
- [x] **Step 2: Wire OCR into `MultimodalPipeline`**
...
- [x] **Step 1: Add the event handler**
...
- [x] **Step 1: Implement (no emoji per project preference — use unicode or text icons)**
...
- [x] **Step 1: Pre-task M3.8.0 — persist artifact text per-turn**
...
- [x] **Step 2: Failing test for M3.8.1**
...
- [x] **Step 3: Implement B0 multimodal logic**
...
- [x] **Step 2: Implement `pre_tool_use`**
...
- [x] **Step 2: Commit (script + run-all hook in one commit since they're tightly coupled)**
