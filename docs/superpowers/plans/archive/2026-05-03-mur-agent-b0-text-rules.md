...
- [x] **Step 2: Create the helper module skeleton**
...
- [x] **Step 3: Implement the rule branch**
...
- [x] **Step 3: If `HookCtx` lacks entitlements**
...
- [x] **Step 3: Implement the rule + GrantStore consumption**
...
- [x] **Step 6: Run M3.8 tests to confirm no regression**
...
- [x] **Step 3: Add `regex` if not already a runtime dep**
