...
### - [x] Step 2: Run the test to confirm it compiles but fails
...
### - [x] Step 3: Add the new module to `lib.rs`
...
### - [x] Step 4: Create the empty router file
...
### - [x] Step 5: Create the four (currently empty) handler files
...
### - [x] Step 6: Add `agents_dir` field to `AppState`
...
### - [x] Step 7: Populate `agents_dir` in the test helper
...
### - [x] Step 8: Populate `agents_dir` at the real call site
...
### - [x] Step 9: Mount the nested router
...
### - [x] Step 10: Run the smoke test plus the full server test suite
...
### - [x] Step 1: Write an integration smoke test
...
### - [x] Step 3: Run the full mur-core test suite to catch regressions
