...
- [ ] **Step 2: Create the fixtures used by every test in this milestone**
...
- [ ] **Step 3: Write the failing parse-success test**
...
- [ ] **Step 6: Implement `parse_inbox_md` and `BridgeEvent`**
...
- [ ] **Step 7: Run the parse test and confirm it passes**
...
- [ ] **Step 4: Run scanner tests + build**
...
- [ ] **Step 4: Stub `state.rs` (filled out in M5.3.2)**
...
- [ ] **Step 6: Register the Tauri command**
...
- [ ] **Step 3: Implement `companion_bridge_subscribe` and `_inner`**
...
- [ ] **Step 4: Tighten `BridgeState` so the swap above compiles**
...
- [ ] **Step 5: Run `cargo test --test bridge_state`**
...
- [ ] **Step 4: Implement helpers + Tauri commands**
...
- [ ] **Step 4: Implement `companion_ack_inner` + Tauri command**
...
- [ ] **Step 1: Add `@tauri-apps/plugin-notification` to package.json (if absent)**
...
- [ ] **Step 6: Create `CompanionSidebar.tsx`**
...
- [ ] **Step 8: Vitest sanity test on parsing**
...
- [ ] **Step 2: Confirm runtime ledger location and shape**
...
- [ ] **Step 5: Implement `companion_why_inner` + Tauri command**
...
- [ ] **Step 1: Find the existing CLI verbs**
...
- [ ] **Step 2: Mount `<WhyAccordion />` inside MessageRow**
...
- [ ] **Step 3: Mount the toggles in CompanionSidebar header**
