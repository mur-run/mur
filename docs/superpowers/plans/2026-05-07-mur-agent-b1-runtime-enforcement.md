...
- [ ] **Step 3: Write `SandboxPolicy` + `from_entitlements()`**
...
- [ ] **Step 3: Inject `HostGuard` into all three LLM clients**
...
- [ ] **Step 2: Add `ToolError::Sandboxed` variant**
...
- [ ] **Step 3: Wire `sandbox::apply()` into `supervisor::entrypoint()`**
...
- [ ] **Step 3: Wire into MCP spawn site**
...
- [ ] **Step 2: Add `last_status()` to `sandbox/mod.rs`**
...
- [ ] **Step 3: Add attestation to `B0SafetyHook::on_startup`**
...
- [ ] **Step 1: Write subprocess-based FS deny test (Linux/macOS only)**
...
- [ ] **Step 2: Run all sandbox E2E tests**
