...
- [ ] **Step 3: Add FirstMemory + extend OnboardingState**
...
- [ ] **Step 2: Run + verify pass (no code change needed — schema landed in M2.1.1)**
...
- [ ] **Step 3: Extend VoiceInput + substitution**
...
- [ ] **Step 1: Inspect current morning_greeting seed content**
...
- [ ] **Step 1: Write failing acceptance test (MockClock 72h)**
...
- [ ] **Step 3: Implement first_memory load + threading**
...
- [ ] **Step 3: Extend Answers + run() schema-write paths**
...
- [ ] **Step 1: Inspect current 3-step wizard**
...
- [ ] **Step 4: Manual smoke test (interactive — optional)**
...
- [ ] **Step 1: Locate current preview path**
...
- [ ] **Step 4: Thread first_memory through preview**
...
- [ ] **Step 3: Build + smoke (don't auto-launch full GUI in CI)**
...
- [ ] **Step 1: Detect prior file presence**
...
- [ ] **Step 3: Implement build_card_from_profile**
