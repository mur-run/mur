...
| `mur-core/src/cmd/browser/mod.rs:488` | `mur` CLI path | `portable` | No source change identified; native workspace tests verify the existing fallback. | Task 6 |
| `mur-core/src/cmd/browser/mod.rs:538` | `mur` CLI path | `portable` | No source change identified; native workspace tests verify the existing fallback. | Task 6 |
| `mur-core/src/cmd/browser/mod.rs:566` | `mur` CLI path | `portable` | No source change identified; native workspace tests verify the existing fallback. | Task 6 |
| `mur-core/src/cmd/browser/mod.rs:582` | `mur` CLI path | `portable` | No source change identified; native workspace tests verify the existing fallback. | Task 6 |
| `mur-core/src/cmd/browser/mod.rs:594` | `mur` CLI path | `portable` | No source change identified; native workspace tests verify the existing fallback. | Task 6 |
| `mur-core/src/cmd/browser/mod.rs:603` | `mur` CLI path | `portable` | No source change identified; native workspace tests verify the existing fallback. | Task 6 |
